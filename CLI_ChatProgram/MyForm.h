...
#pragma endregion
	...
	private: void P2P_Disconnection();
	...
	private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		for each (IPAddress ^ ip in hostEntry->AddressList)
		{
			...
			if (ip->AddressFamily == System::Net::Sockets::AddressFamily::InterNetwork)
			{
				...
				server_ipAddress_textBox->Text = ip->ToString();
			}
		}

		server_port_textBox->Text = server_port.ToString();
		others_sever_port_textBox->Text = others_sever_port.ToString();
	}
	...
	private: System::Void server_disconnections_button_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (Client_State == true) {
			state->ForeColor = SystemColors::ControlText.Blue;
